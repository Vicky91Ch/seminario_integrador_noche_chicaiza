...
const INITIAL_TASKS: Task[] = [
  ...
  { id: 3, text: 'Actualizar precios Suzuki GSX',           completed: false },
  { id: 4, text: 'Revisar Kawasaki Z400 en taller',        completed: false },
  { id: 5, text: 'Coordinar entrega de KTM Duke',          completed: false },
]
